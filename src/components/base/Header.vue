<template>
  <nav class="navbar navbar-expand-md navbar-dark mb-4" style="background-color:#3097D1">
        <a href="index.html" class="navbar-brand"><img src="" alt="logo" class="img-fluid" width="80px" height="100px"></a>
        ...
        <div class="collapse navbar-collapse" id="responsive">
            ...
            <form action="" class="form-inline ml-auto d-none d-md-block float-right">
            ...
            <img src="" alt="" class="rounded-circle ml-3 d-none d-md-block" width="32px" height="32px">
        </div>
</nav>
</template>
